...
//
//   node scripts/screenshot.mjs out.png [popup.html] [light|dark] [width] ["<js to run first>"]
//
...
const [out, page = 'popup.html', scheme = 'light', width = '420', script = ''] = process.argv.slice(2);
